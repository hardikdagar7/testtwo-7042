[testtwo-7042] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [testtwo-7042] container is NOT running**.

.. tip::
   You must have your [testtwo-7042] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33961  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='hardikdagar7'  \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env MQTTUSERNAME='hardikdagar0207'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hardikdagar0207/testtwo-7042-amd64 (https://hub.docker.com/r/hardikdagar0207/testtwo-7042-amd64)
...
.. important::
   docker run -d -p 54245:54245 -p 52471:52471 -p 53251:53251 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=testtwo-7042 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-testtwo-7042 \-\-env GITUSERNAME=hardikdagar7  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=54245  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=52471  \-\-env SOLUTIONVIPERVIZPORT=53251 \-\-env DOCKERUSERNAME='hardikdagar0207' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=33961 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hardikdagar0207' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hardikdagar0207/testtwo-7042-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hardikdagar0207/testtwo-7042-amd64
...
[testtwo-7042] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/hardikdagar7/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/testtwo-7042
...
.. important::
   https://testtwo-7042.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-testtwo-7042
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=54245, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43859, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39575, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=41315, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33185, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=39503, HPDEHOST=127.0.1.1, HPDEPORT=44451, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=43657

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1229-testtwo-7042,solution_preprocessing_ai_mqtt_dag-testtwo-7042, python-preprocess-6216-testtwo-7042,solution_preprocessing_ai_mqtt_dag-testtwo-7042, python-ai-63-testtwo-7042,solution_preprocessing_ai_mqtt_dag-testtwo-7042, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
